		  ...
		  <!-- /. PAGE TITLE-->
			...
			<div class="row">	
					<c:forEach items="${list}" var="list">
						<div class="span6">			
								<div class="media">
									 <a href="#" class="pull-left"><img src="${list.listenexerciseimage}" class="media-object" alt='' width="128px" height="128px"/></a>
									<div class="media-body">
										 
										<p>
											${list.listenexercisename}
										</p>
										<a href="Lambtnghe?listenexerciseid=${list.listenexerciseid}&pageid=1" class="btn" type="button">Chi tiết</a>
					...
					<div class="pagination">
						<ul>
							<c:if test="${pageid == 1}">
							   ...
							   <li><a href = "Hienthidsbtnghe?pageid=${pageid+1}">Next</a></li>
						   </c:if>
						   <c:if test="${pageid == maxpageid}">
							   <li><a href = "Hienthidsbtnghe?pageid=${pageid-1}">Prev</a></li>
							  
							   <li class = "disabled"><a href ="#">Next</a></li>
						   </c:if>
						   
						   <c:if test="${pageid > 1 && pageid < maxpageid}">
							   <li><a href = "Hienthidsbtnghepageid=${pageid-1}">Prev</a></li>
