		  ...
		  <!-- /. PAGE TITLE-->
			...
			<div class="row">	
								...
								<div class="thumbnail">
									<div class="reading_description" style="overflow: auto; height: 400px" >
										<c:forEach items= "${listcorrectanswer}" var= "listcorrectanswer">
											...
											<c:if test="${(listcorrectanswer.imagequestion!='x')&&(listcorrectanswer.audiogg!='x')&&(listcorrectanswer.audiomp3!='x')}">
											...
											<c:if test="${(listcorrectanswer.imagequestion=='x')&&(listcorrectanswer.audiogg=='x')&&(listcorrectanswer.audiomp3=='x')}">
													...
													<c:if test="${listcorrectanswer.correctanswer == 'A'}">
														<c:if test="${listcorrectanswer.paragraph != 'x'}" > 
														<p> 	
						...
						<div class="span3">			
								...
								<a href="LamdethiFoward?pageid=1" role="button" class="btn btn-primary" >Làm lại</a>
