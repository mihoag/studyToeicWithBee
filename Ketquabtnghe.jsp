		...
		<c:forEach items="${dapandungbtnghe}" var ="listcorrectanswer">
						<c:if test="${listcorrectanswer.correctanswer == 'A'}">
							<c:if test="${kq == 'A'}">
								...
								<p>
									<img src= "FileAudioImageListening/${listcorrectanswer.imagename}" alt="" style="width:250px;height:150px;"/>
								</p>
								<p>
									<audio controls>
										<source src="FileAudioImageListening/${listcorrectanswer.audiogg}" type="audio/ogg">
										<source src="FileAudioImageListening/${listcorrectanswer.audiomp3}" type="audio/mpeg">
									</audio>
								</p>
								<p>
