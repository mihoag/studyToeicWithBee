    ...
    <script src="Template/Frontend/js/bootstrap.min.js"></script>
    	...
    	<script type="text/javascript">
					...
					function Xuatketqua()
					{
						...
						var url = "Lambtnghe?kq="+kq+"&listenquestionid="+<%=request.getAttribute("listenquestionid")%>+"&listenexerciseid="+<%=request.getAttribute("listenexerciseid")%>;
					...
					<li class="span12">
						<div class="thumbnail" >
							...
							<c:forEach items="${list}" var ="list">
								...
								<p>
									<img src= "FileAudioImageListening/${list.imagename}" alt="" style="width:250px;height:150px;"/>
									
								</p>
								<p>
									
									<audio controls>
										<source src="FileAudioImageListening/${list.audiogg}" type="audio/ogg">
										<source src="FileAudioImageListening/${list.audiomp3}" type="audio/mpeg">
									</audio>
