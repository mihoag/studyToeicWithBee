...
/**
 * Servlet implementation class UploadndTuVung
 */
@WebServlet("/UploadndTuVung")
public class UploadndTuVung extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UploadndTuVung() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		final String Address =  context.getRealPath("Filevocabulary/");
		String id = request.getParameter("vocabularyguidelineid");
			    ...
			    if (!item.isFormField()) 
			    {
			    	...
			    	try 
			    	{
			    		if (kt == true)
			    		{
			    			...
			    			RequestDispatcher rd = request.getRequestDispatcher("Themndchudetuvung");
			    		...
			    		else
			    		{
							...
							RequestDispatcher r = request.getRequestDispatcher("Themndchudetuvung");
