...
/**
 * Servlet implementation class Themcauhoibtnghe
 */
...
public class Themcauhoibtnghe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    RequestDispatcher r = request.getRequestDispatcher("Admin/Themcauhoibtnghe.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String id = request.getParameter("listenexerciseid");
	    ServletContext context = request.getServletContext();
		final String Address =  context.getRealPath("Filebtnghe/");
			    ...
			    if (!item.isFormField()) 
			    {
			    	...
			    	try 
			    	{
			    		if (kt == true)
			    		{
			    			...
			    			RequestDispatcher rd = request.getRequestDispatcher("Thembtnghecontroller");
						...
						//	System.out.println(id);
							...
							RequestDispatcher r = request.getRequestDispatcher("Thembtnghecontroller");
						    r.forward(request, response);
			    		}
					} 
			    	catch (Exception e) 
