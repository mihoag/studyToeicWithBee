...
public examinationquestion(int examinationquestionid, int num, String imagequestion, String audiogg, String audiomp3,
		String paragraph, String question, String option1, String option2, String option3, String option4,
		String correctanswer, int examinationid) {
	super();
