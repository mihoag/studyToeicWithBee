...
<body onLoad="auto_submit1();">
	...
	<div class="container">
		...
		<div class="row">
				...
				<div id="paginationdemo" class="thumbnail">
					<div class="reading_description" style="overflow: auto; height: 400px" >
							...
							<c:forEach items="${list}" var ="list">
								<c:if test="${(list.imagequestion!='x')&&(list.audiogg!='x')&&(list.audiomp3!='x')}">
									<div id="p${list.num+1}" style="display:none;">
											...
											<b>Câu ${list.num}. ${list.question}</b><br/>
											<p>${list.option1}</p>
											<p>${list.option2}</p>
											<p>${list.option3}</p>
											<p>${list.option4}</p>							
			...
			<form name="form" action="lamdethi?examinationid=${examinationid}&memberid=${memberid}" method="POST">
				<div class="span4">
					<div class="thumbnail">
						<div class="reading_description" style="overflow: auto; height: 400px" >
